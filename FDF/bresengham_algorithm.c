...
/*   Updated: 2022/10/10 22:40:29 by ooutabac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	check_conditions_and_redirect(points, point1, point2, img);
}
...
void	check_conditions_and_redirect(t_position **points, t_position point1, t_position point2, t_data *img)
{
	int			Pk;
	float		m;
	t_position	single_point;
	t_position	**stored_points;
	...
	{
		draw_vert_line(point2.posy - point1.posy, single_point, point1, img);
		return ;
	}
	else if (point1.posx == point2.posx && point1.posy > point2.posy)
	{
		draw_vert_line_reverse(point1.posy - point2.posy, single_point, point1, img);
		return ;
	}
	...
	if (m < 1 && m > 0 && point1.posx < point2.posx && point1.posy < point2.posy)
		...
		draw_hor_line(point2.posx - point1.posx, single_point, point1, img);
	else if (m == 0 && point1.posx > point2.posx)
		draw_hor_line_reverse(point1.posx - point2.posx, single_point, point1, img);
