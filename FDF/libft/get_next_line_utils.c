...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/30 19:40:35 by ooutabac          #+#    #+#             */
/*   Updated: 2022/09/01 19:40:09 by ooutabac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

void	ft_bzero_gtl(void *s, size_t n)
{
	size_t		i;
	int			bzero;
	char		*char_s;
...
*/
void	*ft_calloc_gtl(size_t nmemb, size_t size)
{
	void	*ptr;
...
*/
char	ft_strnchr_gtl(char *haystack, char needle, size_t len)
{
	size_t	i;
...
*/
char	*ft_substr_gtl(char *s, unsigned int start, size_t len)
{
	size_t	i;
	size_t	j;
	char	*str;
...
*/
char	*ft_strjoin_gtl(char *s1, char *s2)
{
	size_t		i;
	size_t		j;
	size_t		s1_len;
	...
	i = 0;
	j = 0;
	s1_len = ft_strlen_gtl(s1);
	s2_len = ft_strlen_gtl(s2);
